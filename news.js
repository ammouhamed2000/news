function w2bAdvRecentPostsScrollerv3(json) {
	...
	try {
		...
		document.write("\<style style=\"text/css\"\>.way2blogging-srp a {color: #000000;text-decoration: none;font-size: 15px;font-weight: 400;}.way2blogging-srp{padding:15px;}.way2blogging-srp:before {content: 'جديد الأخبار';position: absolute;right: 15px;background: #b51200;color: #fff;padding: 3px 8px;top: 13px;z-index: 1;border-left: 5px solid #f5f5f5;}.way2blogging-srp {position: relative;}\</style\>")
