...
function recent_post_content(){
    ...
    s += "  <marquee scrolldelay='5' behavior=scroll direction='right' style='  display: block;width: 100%;overflow: hidden;animation: marquee 1s linear infinite;' scrollAmount='5'>";
    for(var i=0; i<latest_post; i++){
